// Fiche de deroulement pedagogique - Peugeot M5
...
const doc = new Document({
  sections: [{
    ...
    children: [
      ...
      new Paragraph({ children: [new TextRun({ text: 'Fiche de déroulement — Mission 4 : L’analyse du CV du commercial automobile', bold: true, size: 30, color: VERT })], spacing: { after: 120 } }),
...
Packer.toBuffer(doc).then((buf) => {
  fs.writeFileSync('/mnt/user-data/outputs/Fiche-deroulement-PEUGEOT-M5.docx', buf)

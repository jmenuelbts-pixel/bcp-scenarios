...
const PEUGEOT_M1: ContenuMission = {
  travaux: {
    ...
    documents: [
      ...
      { numero: 2, titre: 'Les explications du directeur M. Collet', texte: [
        ...
        { paragraphes: [
          "Une concession automobile est un point de vente indépendant qui distribue les véhicules d'une marque avec laquelle il a signé un contrat. Le concessionnaire s'engage à représenter la marque, à vendre ses véhicules neufs et à assurer le service après-vente sur un territoire défini.",
        ] },
        { intertitre: 'Les particularités du contrat de concession' },
        { puces: [
          "L'exclusivité territoriale : le concessionnaire distribue la marque sur un secteur géographique délimité.",
          "L'engagement d'approvisionnement : le concessionnaire s'engage à se fournir exclusivement auprès de la marque (le constructeur).",
          "Le respect des normes de la marque : le concessionnaire s'engage à respecter les standards du constructeur (image, services, showroom, après-vente).",
        ] },
      ] },
    ],
    objectifs: [
    ...
    questions: [
      {
        ...
        bareme: 6,
        reponse:
          "En 2020 : plus de 6 000 concessionnaires (et près de 8 000 agents de marque). Groupe Parot : 91 millions d'euros en 2022 contre 87,4 millions en 2021, soit une hausse. Les agents de marque et succursales ont perdu des sites (−36) alors que les concessions des grands groupes ont augmenté (+54). En 2021 : +0,54 %, soit environ 9 000 véhicules supplémentaires. L'électrique progresse fortement (13 % de parts de marché en 2022, autant que le diesel). Utilitaires 2022 : −28,60 % en mars, soit 34 055 immatriculations.",
        tableau: {
          colonnes: ['Question', 'Réponse attendue'],
          lignes: [
            ['Concessionnaires en 2020', 'Plus de 6 000 concessionnaires (et près de 8 000 agents de marque)'],
            ['CA groupe Parot 2022 / 2021', '91 M€ en 2022 contre 87,4 M€ en 2021 : hausse'],
            ['Agents/succursales vs grands groupes', 'Les agents et succursales perdent des sites (−36) ; les grands groupes en gagnent (+54)'],
            ['Hausse des ventes 2021', '+0,54 %, soit environ 9 000 véhicules'],
            ['Marché de l\u2019électrique', '13 % de parts de marché en 2022, autant que le diesel'],
            ['Utilitaires 2022', '−28,60 % en mars, soit 34 055 immatriculations'],
          ],
        },
      },
      {
        ...
        bareme: 2,
        reponse:
          "Une concession automobile est un point de vente indépendant qui a signé un contrat avec une marque pour distribuer ses véhicules neufs et assurer le service après-vente sur un territoire défini.",
      },
      {
        ...
        bareme: 3,
        reponse:
          "1) L'exclusivité territoriale (un secteur géographique délimité). 2) L'engagement de se fournir auprès de la marque (le constructeur). 3) Le respect des normes et standards de la marque.",
        tableau: {
          colonnes: ['Particularité', 'Explication'],
          lignes: [
            ['Exclusivité territoriale', 'Le concessionnaire distribue la marque sur un secteur délimité'],
            ['Engagement d\u2019approvisionnement', 'Il s\u2019engage à se fournir auprès de la marque (constructeur)'],
            ['Respect des normes de la marque', 'Il respecte les standards du constructeur (image, services, après-vente)'],
          ],
        },
      },
    ],
  ...
  synthese: {
    ...
    proposition: [
      ...
      'Contrat avec une marque',
      'Territoire défini',
      'Exclusivité territoriale',
      'Se fournir auprès de la marque',
      'Respect des normes',
    ],
    racine: {
      id: 'racine',
      ...
      enfants: [
        {
          ...
          texte: 'Définition',
          enfants: [
            { id: 'd-1', texte: null, reponse: 'Point de vente indépendant' },
            { id: 'd-2', texte: null, reponse: 'Contrat avec une marque' },
            { id: 'd-3', texte: null, reponse: 'Territoire défini' },
          ],
        },
        {
          id: 'contrat',
          texte: 'Le contrat de concession',
          enfants: [
            { id: 'c-1', texte: null, reponse: 'Exclusivité territoriale' },
            { id: 'c-2', texte: null, reponse: 'Se fournir auprès de la marque' },
            { id: 'c-3', texte: null, reponse: 'Respect des normes' },
          ],
        },
      ],
    },
  ...
  activites: {
    glossaire: [
      { terme: 'Concession automobile', definition: "Point de vente indépendant qui distribue les véhicules d'une marque avec laquelle il a signé un contrat, sur un territoire défini." },
      { terme: 'Contrat de concession', definition: "Contrat par lequel un commerçant indépendant distribue les produits d'une marque sur un secteur défini, en respectant ses normes." },
    ...
    flashcards: [
      { recto: "Qu'est-ce qu'une concession automobile ?", verso: "Un point de vente indépendant qui distribue les véhicules d'une marque sous contrat, sur un territoire défini." },
      { recto: 'Citez une particularité du contrat de concession.', verso: "Au choix : exclusivité territoriale, engagement de s'approvisionner auprès de la marque, respect des normes." },
    ...
    quiz: [
      { type: 'unique', question: "Qu'est-ce qu'une concession automobile ?", options: ['Un point de vente indépendant qui distribue une marque sous contrat', 'Une usine de fabrication de voitures', 'Un simple garage sans lien avec une marque'], bonne: 0 },
      { type: 'unique', question: 'Combien de concessionnaires en France en 2020 ?', options: ['Plus de 6 000', 'Environ 500', 'Plus de 50 000'], bonne: 0 },
      ...
      { type: 'qcm', question: 'Quelles sont les particularités du contrat de concession ?', options: ['Exclusivité territoriale', 'Se fournir auprès de la marque', 'Respect des normes de la marque', 'Vente de produits alimentaires'], bonnes: [0, 1, 2] },
      ...
      { type: 'trous', texte: 'Le concessionnaire s\u2019engage à se fournir auprès de la {0} sur un {1} défini.', reponses: ['marque', 'territoire'] },
    ...
    glisserDeposer: {
      ...
      zones: [
        { libelle: 'Exclusivité territoriale', etiquetteIndex: 0 },
        { libelle: '1,66 million de véhicules neufs vendus en 2021', etiquetteIndex: 1 },
        { libelle: 'Se fournir auprès de la marque', etiquetteIndex: 0 },

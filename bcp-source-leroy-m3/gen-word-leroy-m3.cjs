...
function consignes() {
  return [
    H('Activité 4 – La disponibilité du produit et la fiche client'),
    ...
    H('Activité 1 – Vente additionnelle : différencier la vente complémentaire et la vente supplémentaire'),
    ...
    H('Activité 2 – Les notions de « up-selling » et de « down-selling »'),
    ...
    H("Activité 3 – La proposition d'un produit additionnel"),
...
function documents() {
  ...
  out.push(tbl([
    new TableRow({ children: [cell('Modèle', { head: true, width: 28 }), cell('Dimensions', { head: true, width: 27 }), cell('Prix / Réf / coloris', { head: true, width: 45 })] }),
    ...[['Dressing blanc semi-fermé', 'H 200cm – L 240cm – P 45 cm', '1490,86 € — Réf : 83013039 — Coloris : anthracite (gris) – blanc – couleur chêne'], ['Armoire dressing semi-fermé', 'H 200cm – L 220cm – P 45 cm', '1580,66 € — Réf : 83299656 — Coloris : anthracite (gris) – blanc – couleur chêne'], ['Dressing chêne / miroir semi-fermé', 'H 200cm – L 120cm – P 45 cm', '1539,29 € — Réf : 83299673 — Coloris : anthracite (gris) – blanc – couleur chêne'], ['Dressing semi-fermé avec lumière', 'H 200cm – L 240cm – P 45 cm', '1586,66 € — Réf : 83013042 — Coloris : anthracite (gris) – blanc – couleur chêne'], ['Dressing', 'H 190cm – L 240cm – P 45 cm', '1510,29 € — Réf : 83299639 — Coloris : anthracite (gris) – blanc – couleur chêne'], ['Armoire dressing ouvert', 'H 200cm – L 120cm – P 45 cm', '1219,28 € — Réf : 83013039 — Coloris : anthracite (gris) – blanc – couleur chêne']].map((r) => new TableRow({ children: [cell(r[0], { fill: true, b: true }), cell(r[1]), cell(r[2])] })),
  ]))

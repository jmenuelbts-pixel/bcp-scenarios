...
const LEROY_MERLIN_M3: ContenuMission = {
  travaux: {
    ...
    documents: [
      ...
      },
      {
        ...
        texte: [
          ...
          {
            tableau: {
              colonnes: ['Modèle', 'Dimensions', 'Prix / Réf / coloris'],
              lignes: [
                ['Dressing blanc semi-fermé', 'H 200cm – L 240cm – P 45 cm', '1490,86 € — Réf : 83013039 — Coloris : anthracite (gris) – blanc – couleur chêne'],
                ['Armoire dressing semi-fermé', 'H 200cm – L 220cm – P 45 cm', '1580,66 € — Réf : 83299656 — Coloris : anthracite (gris) – blanc – couleur chêne'],
                ['Dressing chêne / miroir semi-fermé', 'H 200cm – L 120cm – P 45 cm', '1539,29 € — Réf : 83299673 — Coloris : anthracite (gris) – blanc – couleur chêne'],
                ['Dressing semi-fermé avec lumière', 'H 200cm – L 240cm – P 45 cm', '1586,66 € — Réf : 83013042 — Coloris : anthracite (gris) – blanc – couleur chêne'],
                ['Dressing', 'H 190cm – L 240cm – P 45 cm', '1510,29 € — Réf : 83299639 — Coloris : anthracite (gris) – blanc – couleur chêne'],
                ['Armoire dressing ouvert', 'H 200cm – L 120cm – P 45 cm', '1219,28 € — Réf : 83013039 — Coloris : anthracite (gris) – blanc – couleur chêne'],
              ],
            },
          },
    ...
    activites: [
      {
        titre: 'Activité 4 — La disponibilité du produit et la fiche client',
        questions: [
          { numero: 1, consigne: "Consultez le logiciel de l'entreprise afin de pouvoir indiquer au couple si le dressing qu'il a choisi est en stock.", ressources: 'Compléter les annexes 1a et 1b.', annexeId: 'annexe1a' },
      ...
      {
        titre: 'Activité 1 — Vente additionnelle : différencier la vente complémentaire et la vente supplémentaire',
        questions: [
      ...
      {
        titre: 'Activité 2 — Les notions de « up-selling » et de « down-selling »',
        questions: [
      ...
      {
        titre: "Activité 3 — La proposition d'un produit additionnel",
        questions: [
    ...
    annexes: [
      ...
      },
      {
        ...
        champs: [
          { cle: 'type', libelle: 'Type de client (Particulier / Professionnel)' },
          { cle: 'civilite', libelle: 'Civilité' },
          { cle: 'nom', libelle: 'Nom' },
          { cle: 'prenom', libelle: 'Prénom' },
          { cle: 'adresse', libelle: 'Adresse', lignes: 2 },
          { cle: 'fixe', libelle: 'Téléphone fixe' },
          { cle: 'portable', libelle: 'Téléphone portable' },
          { cle: 'email', libelle: 'Email' },
          { cle: 'produit', libelle: 'Produit acheté' },
          { cle: 'avoir', libelle: 'Montant avoir' },
          { cle: 'commentaire', libelle: 'Commentaire', lignes: 2 },
        ],
      },
      {
        type: 'grille',

...
function BlocCatalogue({ a, saisies, set, verrouille, couleur }: {
  ...
  // Icone generique d'accessoire (pas de photo : reseau bloque).
  const vignette = (
    <svg width="100%" height="84" viewBox="0 0 120 84" style={{ display: 'block', background: '#F2F5F8' }}>
      <rect x="30" y="24" width="60" height="40" rx="6" fill="#D9E2EC" />
      <circle cx="46" cy="64" r="6" fill="#B7C2CD" />
      <circle cx="74" cy="64" r="6" fill="#B7C2CD" />
      <rect x="40" y="32" width="40" height="8" rx="2" fill="#C2CCD6" />
    </svg>
  )

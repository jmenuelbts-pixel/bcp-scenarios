...
function NoteDirectionVue({ data }: { data: { titre: string; signature?: string; intro?: string; paragraphe?: string; puces: string[] } }) {
  return (

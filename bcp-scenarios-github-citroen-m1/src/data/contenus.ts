...
const CITROEN_M1: ContenuMission = {
  travaux: {
    ...
    contexte:
      "Vous êtes en PFMP dans l'entreprise Citroën depuis quelques jours. Votre tuteur vous demande d'analyser en profondeur la marque : son histoire, ses valeurs, son positionnement sur le marché et sa gamme de produits. Fil rouge : Clara, 19 ans, en BTS NDRC, et son père Marc viennent chercher une citadine.",
    documents: [

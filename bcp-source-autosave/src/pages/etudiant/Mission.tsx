...
import { viderFileBrouillons } from '../../lib/brouillon'
...
export function Mission() {
  ...
  // Filet anti-perte : avant une fermeture/recharge de page, on force l'envoi
  // immediat des brouillons en attente dans le debounce.
  useEffect(() => {
    const surFermeture = () => viderFileBrouillons()

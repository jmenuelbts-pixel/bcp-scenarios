...
export function OngletTravaux({ contenu, couleur, etudiantId, missionId }: Props) {
  ...
  useEffect(() => {
    ...
    chargerTravail(etudiantId, missionId).then((c) => {
      ...
      // Pas d'envoi enregistre : on restaure le brouillon en cours si present.
      lireBrouillon<Saisies>(etudiantId, missionId, 'travaux').then((b) => {
  ...
  function set(id: string, val: string) {
    ...
    setSaisies((s) => {
      const maj = { ...s, [id]: val }
      sauverBrouillon(etudiantId, missionId, 'travaux', maj)
      return maj
    })
  }
          ...
          {act.questions.map((q) => {
            ...
            return (
              <div key={q.numero} style={{ marginBottom: 16 }}>
                ...
                {annexe2 && annexe2.type !== 'powerpoint' && (

    ...
    <div style={{ border: '1px solid #E2E8F0', borderRadius: 10, background: '#FFFFFF', padding: 20, boxShadow: '0 1px 6px rgba(0,0,0,0.06)', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 18 }}>
        <div style={{ flex: '1 1 240px', minWidth: 220 }}>
          <div style={{ fontSize: 17, fontWeight: 800 }}>ConcessionCollet</div>
          <div style={lib}>SARL (societe a responsabilite limitee)</div>
          <div style={lib}>42 rue Jouffroy d'Abbans</div>
          <div style={lib}>75017 Paris</div>
          {/* ANOMALIE : RCS manquant (chapitre 1) -> volontairement absent */}
          {data.image && <img src={data.image} alt="Peugeot e-208" style={{ width: '100%', maxWidth: 320, marginTop: 12 }} />}
        </div>

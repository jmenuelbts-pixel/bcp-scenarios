...
const el=new Document({sections:[{children:[
  ...
  bullet("Créez le questionnaire de satisfaction (1 question par thème) puis mettez-le en forme Google Form. (Lire les documents 4, 5 et 6, compléter l'annexe 6)"),

  ...
  travaux: {
    ...
    annexes: [
      ...
      },
      {
        ...
        introTexte: 'Reportez les réponses du couple Sankouraga (document 7) dans le configurateur. Renseignez les dimensions, les caissons, les tiroirs et accessoires, puis obtenez le produit correspondant.',
        introBouton: 'Je conçois mon dressing',
        nbEtapesAffiche: 15,
        etapes: [
          { id: 'plafond', bandeau: 'DIMENSIONS', question: 'Hauteur plafond', options: [
          ...
          { id: 'murg', bandeau: 'DIMENSIONS', question: 'Largeur du mur de gauche', options: [
            { libelle: '320 cm', vers: 'murf' }, { libelle: '330 cm', vers: 'murf' }, { libelle: '340 cm', vers: 'murf' }, { libelle: '350 cm', vers: 'murf' },
          ] },
          { id: 'murf', bandeau: 'DIMENSIONS', question: "Largeur du mur d'en face", options: [
            { libelle: '380 cm', vers: 'murd' }, { libelle: '390 cm', vers: 'murd' }, { libelle: '400 cm', vers: 'murd' },
          ] },
          { id: 'murd', bandeau: 'DIMENSIONS', question: 'Largeur du mur de droite', options: [
            { libelle: '320 cm', vers: 'mursm' }, { libelle: '330 cm', vers: 'mursm' }, { libelle: '340 cm', vers: 'mursm' }, { libelle: '350 cm', vers: 'mursm' },
          ] },
          { id: 'mursm', bandeau: 'DIMENSIONS', question: 'Couleur des murs', options: [
            { libelle: 'Blanc', vers: 'sol' }, { libelle: 'Gris', vers: 'sol' }, { libelle: 'Beige', vers: 'sol' }, { libelle: 'Vert', vers: 'sol' },
          ] },
          { id: 'sol', bandeau: 'DIMENSIONS', question: 'Couleur du sol', options: [
            { libelle: 'Marron', vers: 'contraintes' }, { libelle: 'Blanc', vers: 'contraintes' }, { libelle: 'Gris', vers: 'contraintes' }, { libelle: 'Beige', vers: 'contraintes' },
          ] },
          { id: 'contraintes', bandeau: 'DIMENSIONS', question: 'Contraintes', options: [
            { libelle: 'Aucune', vers: 'decor' }, { libelle: 'Fenêtres', vers: 'decor' }, { libelle: 'Portes', vers: 'decor' }, { libelle: 'Escaliers', vers: 'decor' },
          ] },
          { id: 'decor', bandeau: 'CAISSONS', question: 'Choix du décor (couleur)', options: [
            { libelle: 'Effet chêne naturel', vers: 'profondeur' }, { libelle: 'Blanc', vers: 'profondeur' }, { libelle: 'Anthracite (gris)', vers: 'profondeur' },
          ] },
          { id: 'profondeur', bandeau: 'CAISSONS', question: 'Choix de la profondeur', options: [
            { libelle: '15 cm', vers: 'hauteur' }, { libelle: '30 cm', vers: 'hauteur' }, { libelle: '45 cm', vers: 'hauteur' }, { libelle: '60 cm', vers: 'hauteur' },
          ] },
          { id: 'hauteur', bandeau: 'CAISSONS', question: 'Choix de la hauteur', options: [
            { libelle: '100 cm', vers: 'largeur' }, { libelle: '200 cm', vers: 'largeur' }, { libelle: '240 cm', vers: 'largeur' },
          ] },
          { id: 'largeur', bandeau: 'CAISSONS', question: 'Choix de la largeur', options: [
            { libelle: '200 cm', vers: 'meubles' }, { libelle: '210 cm', vers: 'meubles' }, { libelle: '220 cm', vers: 'meubles' },
          ] },
          { id: 'meubles', bandeau: 'CAISSONS', question: 'Les meubles', options: [
            { libelle: 'Caissons standards', vers: 'tiroirs' }, { libelle: "Caissons d'angle", vers: 'tiroirs' },
          ] },
          { id: 'tiroirs', bandeau: 'TIROIRS ET ACCESSOIRES', question: 'Nombre de tiroirs', options: [
            { libelle: '1', vers: 'poignees' }, { libelle: '2', vers: 'poignees' }, { libelle: '3', vers: 'poignees' }, { libelle: '4', vers: 'poignees' },
          ] },
          { id: 'poignees', bandeau: 'TIROIRS ET ACCESSOIRES', question: 'Types de poignées', options: [
            { libelle: 'Standard (en métal)', vers: 'portes' }, { libelle: 'En bois', vers: 'portes' }, { libelle: 'En plastique', vers: 'portes' },
          ] },
          { id: 'portes', bandeau: 'TIROIRS ET ACCESSOIRES', question: 'Portes', options: [
        ...
        resultats: [
          { id: 'resultat', type: 'ok', texte: "Dressing chêne H.200 x L.240 x P.45cm Home — 1492.86 € / Lot (dont 12.04 € éco-participation). Référence : 83299641. Retrait en magasin : DISPONIBLE. Livraison chez vous : DISPONIBLE." },
        ],
      },
      {
        type: 'grille',

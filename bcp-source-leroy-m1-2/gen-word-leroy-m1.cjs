...
function docConcurrence() {
  return [
    ...
    P('Concurrents directs', { b: true }),
    P("Un concurrent direct est une entreprise ou une organisation qui propose un produit, un service ou un prix similaire ou comparable à celui d'une autre entreprise. Elles ont la même activité principale."),
    bullet("Exemple 1 : Un client qui veut aller à Toulouse il peut le faire avec la compagnie Air France. Concurrents directs d'Air France : Easy Jet, Rayan Air."),
    bullet("Exemple 2 : Un client veut acheter des vêtements chez H&M. Concurrents directs : Bershka, Zara. L'activité principale des deux enseignes est la vente de vêtements."),
    bullet("Exemple 3 : Un client veut acheter un four à micro-onde chez Darty. Concurrent direct : Boulanger. L'activité principale des deux enseignes sont la télé, la Hi-fi et l'électroménager."),
    bullet("Exemple 4 : Un client cherche un appartement chez La Forêt Immobilier. Concurrents directs : ERA Immobilier, Century 21."),
    P('Concurrents indirects', { b: true }),
    P("Un concurrent indirect est une entreprise ou une organisation dont l'activité principale n'est pas la même ou qui propose un produit ou un service comparable ou différent, mais susceptible de répondre au même besoin du consommateur."),
    bullet("Exemple 1 : Concurrents indirects d'Air France : Co-voiturage, Train SNCF."),
    bullet("Exemple 2 : Concurrents indirects d'H&M : Louis Vuitton, Gucci. Ils ne proposent pas du tout les mêmes prix qu'H&M alors même qu'ils vendent aussi des vêtements."),
    bullet("Exemple 3 : Concurrent indirect de Darty : Carrefour. Carrefour vend certes des micro-ondes aussi mais son activité principale est l'alimentaire."),
    bullet("Exemple 4 : Concurrents indirects de La Forêt Immobilier : Agence immobilière en ligne, Magazine (ex : Particulier à Particulier)."),
  ]
}
